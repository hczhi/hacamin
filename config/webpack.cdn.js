const HtmlWebpackPlugin = require('html-webpack-plugin'),
    ...
    entries = {}, // js入口
    newEntries = {},
    buildRoot = require('./mypath.js').cdnRoot,
    htmlRoot = 'src/components/',
    htmls = glob.sync('src/components/**/*.html'),
    htmlCfgs = [], // HtmlWebpackPlugin配置项
    publicPath = require('./mypath.js').cdnPath;//七牛前端资源路径
    ...
    module: {
        ...
        rules: [
            ...
            },
            {
                ...
                use: [
                    'file-loader?name=[name].[ext]?v='+require('./mypath.js').version+'&outputPath=./images/&publicPath='+publicPath+'/images/'
                ]
            },
            {
